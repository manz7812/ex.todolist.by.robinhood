...
class _DonePageState extends State<DonePage> {
  ...
  void _loadMore() async{
    ...
    if (controller.position.pixels ==
      ...
      try{
        context.read<TodolistBloc>().add(OnQueryGetTodoByParamEvent(page: page,loadmore: loadMore, status: 'DONE'));
      } catch(e){
  ...
  void initState() {
    ...
    context.read<TodolistBloc>().add(const OnQueryGetTodoByParamEvent(page: 0,status: 'DONE'));
