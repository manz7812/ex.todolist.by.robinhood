...
class _TodoPageState extends State<TodoPage> {
  ...
  void _loadMore() async{
    ...
    if (controller.position.pixels ==
      ...
      try{
        context.read<TodolistBloc>().add(OnQueryGetTodoByParamEvent(page: page,loadmore: loadMore, status: 'TODO'));
      } catch(e){
  ...
  void initState() {
    ...
    context.read<TodolistBloc>().add(const OnQueryGetTodoByParamEvent(page: 0,status: 'TODO'));
